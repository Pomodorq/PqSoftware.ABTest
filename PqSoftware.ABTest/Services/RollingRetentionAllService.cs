...
{
    public class RollingRetentionAllService : IRollingRetentionService
    {
        ApplicationContext _context;
        public RollingRetentionAllService(ApplicationContext context)
        {
            _context = context;
        }
        public async Task<double> CalculateRollingRetention(int projectId, int days, DateTime? startDate = null)
        {
